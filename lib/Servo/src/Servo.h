...
#define MIN_PULSE_WIDTH       314     // the shortest pulse sent to a servo
#define MAX_PULSE_WIDTH      2510     // the longest pulse sent to a servo
#define DEFAULT_PULSE_WIDTH  1412     // default pulse width when servo is attached
